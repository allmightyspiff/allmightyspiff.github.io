...
(function(factory) {
  ...
  if(typeof exports !== 'undefined') {
    ...
    globalObject.hljs1 = factory({});

    // Finally register the global hljs with AMD.
    if(typeof define === 'function' && define.amd) {
      define([], function() {
        return globalObject.hljs1;
      });
    }
  }
...
hljs.registerLanguage('python', function(hljs) {
  var KEYWORDS = {
    ...
    built_in:
      'abs dict  help  min setattrall dir hex next  sliceany divmod  id  object  sortedascii ' +
      'enumerate input oct staticmethodbin eval  int open  strbool  exec  isinstance  ord sumbytearray' +
      'filter  issubclass  pow superbytes float iter  print tuplecallable  format  len property' +  
      'typechr frozenset list  range varsclassmethod getattr locals  repr  zipcompile globals map' + 
      'reversed  __import__complex hasattr max round  delattr hash  memoryview  set'
  };
  var PROMPT = {
